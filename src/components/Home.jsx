...
function Home() {
  ...
  const { formattedReadme, isLoading, error, viewMode, toggleViewMode } =
    useReadmeGenerator(projectInfo);
  ...
  return (
    <>
      ...
      {error && (
        <p className='text-red-400 text-center my-4 bg-red-900 py-2 px-4 rounded'>
          {error}
        </p>
      )}
      {formattedReadme && (
